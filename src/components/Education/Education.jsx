                ...
                {education.map((education, index) => (
                    <div className={styles.educationItemContainer} key={index}>
                        ...
                        <div className={styles.EducationTexts}>
                            <p className={styles.EducationTextsTitle}>{education.title}</p>
                            <p className={styles.EducationTextsProfession}>{education.profession}</p>
                            <p className={styles.EducationTextsDate}>{education.date}</p>
                        </div>
                    </div>
                ))}
