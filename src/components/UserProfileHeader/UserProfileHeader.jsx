...
const UserProfileHeader = () => {
    ...
    <div className={styles.ProfileName}>
        <div className={styles.ProfileNameItems}>
            <img className={styles.ProfileNameItemsPicture} src='/src/assets/images/ProfilePicture.jpg' width={165} height={165} alt='Profile picture' />
            <div className={styles.ProfileNameItemsTextItems}>
                <div className={styles.ProfileNameItemsTexts}>
                    <h2 className={styles.ProfileNameItemsTextsHeader}>Name Surname</h2>
                ...
                <div className={styles.ProfileNameItemsLinks}>
                    <div className={styles.ProfileNameItemsLinksPhone}>
                        ...
                        <p className={styles.ProfileNameItemsLinksText}>+33757005467</p>
                    </div>
                    <div className={styles.ProfileNameItemsLinksMail}>
                        ...
                        <p className={styles.ProfileNameItemsLinksText}>charles5182@ummoh.com</p>
                    </div>
